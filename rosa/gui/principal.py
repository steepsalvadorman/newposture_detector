...
from rosa.detection.camara import HiloCamara
from rosa.export.excel import agregar_registro_excel, crear_excel_nuevo
from rosa.core.recomendaciones import cfg_efectiva, recomendaciones_alerta
from rosa.core.calculos import C, GUARDADO_SEG, INTERVALO_EVAL_SEG, NIVEL_ACCION, NIVELES, WINSOUND_OK
...
def _ruta_recurso(*partes):
    if getattr(sys, "frozen", False):
        ...
        # rosa/gui/principal.py → subir 3 dirs para llegar a la raíz del proyecto
