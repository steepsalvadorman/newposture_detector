...
# En un exe PyInstaller frozen el modelo estará en _MEIPASS/; en desarrollo en models/
if getattr(sys, "frozen", False):
    _RUNTIME_ROOT = sys._MEIPASS
    OBJECT_MODEL_PATH = os.path.join(_RUNTIME_ROOT, "efficientdet_lite0.tflite")
else:
    # rosa/core/calculos.py → subir 3 niveles para llegar a la raíz del proyecto
    _PROJECT_ROOT = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
    OBJECT_MODEL_PATH = os.path.join(_PROJECT_ROOT, "models", "efficientdet_lite0.tflite")
...
def calcular_ROSA_completo_v5(
    ...
    b1 = puntuar_B1(telefono_alejado, sujecion_hombro_cuello, sin_manos_libres, ft_telefono)
